...
public class ShoppingRvAdapter extends RecyclerView.Adapter<ShoppingRvAdapter.ViewHolder> {
    ...
    public ShoppingRvAdapter(Context context, List<ItemModel> product, RecyclerViewClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.shopping_temp,parent,false);
